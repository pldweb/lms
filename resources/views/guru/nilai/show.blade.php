    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{ url('/guru/nilai/edit/' . $nilai->id) }}" class="btn btn-warning">
                            <i class="ph ph-pencil"></i> Edit Nilai
                        </a>
                        <a href="{{ url('/guru/tugas/show/' . $nilai->pengumpulanTugas->tugas_id) }}" class="btn btn-primary">
