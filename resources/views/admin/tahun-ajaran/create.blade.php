    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ url('/admin/tahun-ajaran') }}" class="btn btn-secondary btn-sm btn-add">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-10">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="keterangan" name="keterangan" style="height: auto;" rows="4" maxlength="255" placeholder="Keterangan tambahan (opsional)">{{ old('keterangan') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-add">Simpan</button>
                        <a href="{{ url('/admin/tahun-ajaran') }}" class="btn btn-secondary btn-add">Batal</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    $(document).ready(function() {
        ...
        $('#form-tahun-ajaran').submit(function(e) {
            ...
            confirmModal('Apakah data yang kamu masukkan sudah benar?', function (){
                ajxProcess('/admin/tahun-ajaran/store', dataInput, '#message-modal')
            })
        })
