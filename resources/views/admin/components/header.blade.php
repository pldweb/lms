<div class="top-navbar flex-between gap-16">
            ...
            <div class="flex-align gap-16">
                ...
                <div class="dropdown">
                    <button class="users arrow-down-icon border border-gray-200 rounded-pill p-4 d-inline-block pe-40 position-relative" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="position-relative">
                            <img src="{{Auth::user()->foto_profile ? Storage::url(Auth::user()->foto_profile) : asset('admin/images/thumbs/avatar.png')}}" alt="Image" class="h-32 w-32 rounded-circle">
                        ...
                        <div class="card border border-gray-100 rounded-12 box-shadow-custom">
                            <div class="card-body">
                                <div class="flex-align gap-8 mb-20 pb-20 border-bottom border-gray-100">
                                    <img src="{{Auth::user()->foto_profile ? Storage::url(Auth::user()->foto_profile) : asset('admin/images/thumbs/avatar.png')}}" alt="" class="w-54 h-54 rounded-circle">
                                    <div class="">
        ...
        <script>
            $('#post-logout').click(function(e){
                e.preventDefault();
                confirmModal('Anda yakin ingin logout?', function(){
