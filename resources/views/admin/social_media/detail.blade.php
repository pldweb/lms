...
@section('title', $socialMedia ? 'Edit Social Media' : 'Tambah Social Media')
    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.social_media') }}">Social Media</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ $socialMedia ? 'Edit' : 'Tambah' }}</li>
            </ol>
        </nav>
        <h2 class="h4">{{ $socialMedia ? 'Edit Social Media' : 'Tambah Social Media' }}</h2>
        <p class="mb-0">{{ $socialMedia ? 'Ubah data social media' : 'Tambahkan social media baru' }}</p>
    </div>
</div>
        ...
        <div class="card border-0 shadow mb-4">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h2 class="h5 mb-0">Informasi Social Media</h2>
                    </div>
                </div>
            </div>
            <div class="card-body">
