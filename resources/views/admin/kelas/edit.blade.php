...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="/admin/kelas/show/{{ $kelas->id }}" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm">
        ...
        <div class="card-body">
            <form action="/admin/kelas/update/{{ $kelas->id }}" method="POST">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                      ...
                                      name="deskripsi" 
                                      rows="3" 
                                      placeholder="Deskripsi kelas...">{{ old('deskripsi', $kelas->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-plaintext">
                                <small class="text-muted">
                                    <strong>Dibuat:</strong> {{ \Carbon\Carbon::parse($kelas->created_at)->format('d/m/Y H:i') }}<br>
                                    <strong>Diupdate:</strong> {{ \Carbon\Carbon::parse($kelas->updated_at)->format('d/m/Y H:i') }}
                                </small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group text-right">
                    ...
                    <a href="/admin/kelas/show/{{ $kelas->id }}" class="btn btn-info">
...
<script>
    $(document).ready(function() {
        ...
        function updateTingkat() {
            ...
            var currentTingkat = '{{ old("tingkat", $kelas->tingkat) }}';
