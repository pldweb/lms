                ...
                <form method="post" id="form-login" onsubmit="return false;" >
                    ...
                    <div class="mb-24">
                        ...
                        <div class="position-relative">
                            <input type="email" name="email" class="form-control py-11 ps-40" id="fname" placeholder="Tuliskan email Anda">
                    ...
                    <div class="mb-24">
                        ...
                        <div class="position-relative">
                            <input type="password" name="password" class="form-control py-11 ps-40" id="current-password" placeholder="Tuliskan Password Anda" value="">
